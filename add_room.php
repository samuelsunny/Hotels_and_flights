...
if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        {
            // Saving to data base
            $query = "insert into rooms (hotelId, roomName, amenities, price,roomImage) values ('$hotelId','$room_name','$amenities','$price','$imgContent')";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-6">
            <h1 class="display-4 fs-2 text-center"><b>Add room details</b></h1>
        </div>
    </div>
    ...
    <div class="row mt-5 justify-content-center">
        ...
        <form method = "post" enctype="multipart/form-data">
            <div class="row">
                <div class="mb-4">
                    <label for="exampleFormControlInput1" class="form-label">Enter room name</label>
            ...
            <div class="row">
                <div class="mb-3">
                    <label for="formFile" class="form-label">Choose the room image file</label>
