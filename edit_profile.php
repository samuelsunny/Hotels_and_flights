  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12">
            <h4 class="text-primary">Edit payment information</h4>
                ...
                <div class="card mt-1 p-2 bg-light">
                    <div class="card-body"> 
                       ...
                       <div class="row">
                            <div class="col-6">
                            <div class="mb-4">
                                <input type="text" class="form-control"  id = "name_on_card" name = "name_on_card"  placeholder="Enter the name on the card" value="<?php echo$users_data[0][8];?>">
                            </div>
            
                            <div class="mb-4">
                                <input type="password" class="form-control" id = "card_number" name = "card_number" placeholder="Enter the card number" value="<?php echo$users_data[0][9];?>">
                            </div>

                            <div class="mb-4">          
                                <div class="row">
                                    <div class="col-6">
                                        <input type="text" class="form-control" id = "expiry_date" name = "expiry_date" placeholder="Card expiry date (MM/YY)" value="<?php echo$users_data[0][10];?>">
                                    </div>
                                    <div class="col-6">
                                        <input type="password" class="form-control" id = "cvv" name = "cvv" placeholder="CVV" value="<?php echo$users_data[0][11];?>">
                                    </div>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="col-6">
                                    ...
                                    <textarea class="form-control" id = "billing_address" name = "billing_address" rows="5" placeholder="" ><?php echo$users_data[0][12];?></textarea>
                            </div>
                       </div>
                </div>
